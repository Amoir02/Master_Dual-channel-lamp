	...
	; Compiler options:
	;
	; -oFWSWES-PAV03-SCENESWITCHES-PAN2416AV.cof \
	; -mFWSWES-PAV03-SCENESWITCHES-PAN2416AV.map \
	; --summary=default,-psect,-class --fill=FFFF --output=intel main.p1 \
	; system.p1 timer0.p1 timer1.p1 timer2.p1 PWM.p1 WDT.p1 rf297L.p1 \
	; delay.p1 INT0.p1 key_scan.p1 PORTB_interrupt.p1 ADC.p1 \
	; virtual_timer.p1 recive.p1 iic.p1 e2prom.p1 --chip=PAN2416AV -P \
	; --runtime=default,+stackcall --opt=default,+asm,-speed,+space,9 \
