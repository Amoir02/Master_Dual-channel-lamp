...
///////////////////////////////////////////////////////////////////////////////
//     芯片型号一定要注意切换，MX5325和PAN2416 RF寄存器配置和功率值不一样       //
///////////////////////////////////////////////////////////////////////////////
//#define 		IC_TYPE_MX5325				     //选择芯片型号，禁掉则为PAN2416配置	
//////////////////////////////////////////////////////////////////////////////////

#define	DEFAULT_CHANNEL	26				   //初始化时的频率： 2478 MHz           
#define	PAYLOAD_WIDTH	18				   //Payload宽度：    			
...
extern void RF_ENHANCE_TxData(unsigned char *payload_buff,unsigned char length,unsigned char *postback_buff);//增强模式下发送
